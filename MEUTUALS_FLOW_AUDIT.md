...
| 18+ eligibility               | Pass                                    | Client guidance plus immutable server-derived verification, restrictive RLS, and write triggers. Underage and incomplete accounts are rejected.                                                                                                                                                                                                           |
