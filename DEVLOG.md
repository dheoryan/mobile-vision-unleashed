...
| ----- | ---- | ----- | ------- |
| Codex | Move Profile settings action into the app header | `DEVLOG.md`, `src/components/mutuals/Shared.tsx`, `src/components/mutuals/ProfileScreen.tsx` | 2026-08-28 |
