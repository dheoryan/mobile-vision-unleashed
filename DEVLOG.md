...
| ----- | ---- | ----- | ------- |
| Codex | Modal-free focused post comments | `src/routes/{p.$postId,index,notifications}.tsx`, `src/components/mutuals/{PostCard,CommentsModal}.tsx`, `tests/{ios-pwa-comments,post-navigation,notification-groups}.test.ts`, `DEVLOG.md` | 2026-08-30 |
