...
| ----- | ---- | ----- | ------- |
| Codex | Modal-free focused post comments | `src/routes/p.$postId.tsx`, `src/components/mutuals/{PostCard,CommentsModal}.tsx`, `tests/{ios-pwa-comments,post-navigation}.test.ts`, `DEVLOG.md` | 2026-08-30 |
