...
| ----- | ---- | ----- | ------- |
| Codex | Comments conversation-sheet redesign | `src/components/mutuals/CommentsModal.tsx`, `tests/{ios-pwa-comments,comment-social}.test.ts`, `DEVLOG.md` | 2026-08-30 |
