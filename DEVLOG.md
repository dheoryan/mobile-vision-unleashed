...
|---|---|---|---|
| Codex | Installed PWA completion | `public/manifest.webmanifest`, `public/sw.js`, PWA icons/screenshots/offline assets, `src/routes/__root.tsx`, `src/lib/install-prompt.ts`, `src/lib/auth-context.tsx`, `src/lib/ventures-mode.ts`, `src/components/mutuals/VenturesScreen.tsx`, install/update UX, PWA tests/docs | 2026-08-24 |
