...
export const TRIBES: Tribe[] = [
  { id: "wolf", name: "Iron Wolf", scene: "Sports & Healthy Lifestyle", art: ironWolfArt, crest: ironWolfCrest, motto: "Move together. Grow stronger.", about: "A high-energy home for people who build friendship through movement, consistency, and showing up for one another.", inside: ["Local runs and training", "Recovery and healthy habits", "Activity partners"], bestFor: "People who would rather connect while doing than sit through small talk.", colorVar: "var(--tribe-wolf)", members: 12480, online: 312 },
  { id: "koi", name: "Mindful Koi", scene: "Books & Thoughtful Hobbies", art: koiArt, crest: koiCrest, motto: "Follow curiosity slowly.", about: "A quieter current for readers, collectors, learners, and people who enjoy thoughtful conversations without rushing them.", inside: ["Book and film circles", "Slow hobbies and learning", "Café conversations"], bestFor: "Curious minds who prefer depth, reflection, and low-pressure connection.", colorVar: "var(--tribe-koi)", members: 8210, online: 184 },
  { id: "cat", name: "Studio Cat", scene: "Music & Arts", art: studioCatArt, crest: studioCatCrest, motto: "Make something worth sharing.", about: "A creative room for artists, musicians, designers, and enthusiastic beginners to exchange work, ideas, and invitations.", inside: ["Open mics and exhibitions", "Works in progress", "Creative collaborators"], bestFor: "People energized by expression, experimentation, and making things together.", colorVar: "var(--tribe-cat)", members: 15640, online: 521 },
  { id: "owl", name: "Night Owl", scene: "Nightlife & Late-Night Talks", art: nightOwlArt, crest: nightOwlCrest, motto: "The city changes after dark.", about: "An after-hours circle for spontaneous plans, hidden venues, and conversations that become more honest when the day winds down.", inside: ["Late food and walks", "Nightlife discoveries", "After-dark conversations"], bestFor: "People whose social energy arrives late and who enjoy plans with a little spontaneity.", colorVar: "var(--tribe-owl)", members: 9970, online: 402 },
  { id: "bee", name: "Honeybee", scene: "Professional Workers", art: honeybeeArt, crest: honeybeeCrest, motto: "Build well. Share what works.", about: "A generous professional network where useful introductions, practical knowledge, and collaborative momentum matter more than self-promotion.", inside: ["Peer problem-solving", "Skill and idea exchange", "Collaborative ventures"], bestFor: "Builders and professionals looking for useful relationships with a human side.", colorVar: "var(--tribe-bee)", members: 11230, online: 276, hosted: true, hostOrg: "Sightglass × Meutuals" },
];
