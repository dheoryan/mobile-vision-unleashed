...
const KIND_CATEGORY: Record<PushNotificationKind, PushPreferenceKey> = {
  ...
  venture_decline: "venture_activity",
  venture_invite_accept: "venture_activity",
  venture_invite_decline: "venture_activity",
  venture_withdraw: "venture_activity",
  venture_leave: "venture_activity",
